...
Menu::Menu(float _width, float _height){
    ...
    menuBox.setPosition(sf::Vector2f(width,height));
    ...
    menuItems[0].setPosition(sf::Vector2f(width + 30.0f, height + 25.0f));

    // Initialize the second menu item
    menuItems[1].setFont(font);
    menuItems[1].setFillColor(sf::Color::Black);
    menuItems[1].setString("Map");
    menuItems[1].setPosition(sf::Vector2f(width + 30.0f, (height + 75.0f)));
